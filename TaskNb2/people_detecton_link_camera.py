...
def detect_people_live():
    # Use the public stream URL instead of the webcam
    cap = cv2.VideoCapture("https://csea-me-webcam.cse.umn.edu/mjpg/video.mjpg")  # Replace with your public stream link
    ...
    client_socket.connect(('127.0.0.1', 65432))  # Adjust host and port as needed
    ...
    try:
        while True:
            ...
            ret, frame = cap.read()
            if not ret:
                print("Error: Failed to capture image from video stream.")
                break
